...
public class Adapter_Maintenance extends RecyclerView.Adapter<Adapter_Maintenance.ViewHolder> {
    ...
    public Adapter_Maintenance(Context context, ArrayList<Model_Merged_List> mergedLists,ArrayList<Model_Merged_List> userLists, ArrayList<Model_Merged_List> networkLists,  ArrayList<Model_Merged_List> pemasanganLists,ArrayList<Model_Merged_List> upgradeLists) {
    ...
    @NonNull
    @Override
    public Adapter_Maintenance.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_maintenance_dashboard, parent, false);
        return new Adapter_Maintenance.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_Maintenance.ViewHolder holder, int position) {
